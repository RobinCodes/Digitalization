...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item Salétromsav
        \\\\Csak vizes oldatban létezik; erős (a $H^+$-ion leadása híg vizes oldatban 100$\%$-os), egyértékű sav (egy sav molekula egy db $H^+$-iont képes leadni)
        \\\\ cc. salétromsav-oldat: kb. 65 tömeg$\%$-os\\\\
        Kísérlet 1.\\
