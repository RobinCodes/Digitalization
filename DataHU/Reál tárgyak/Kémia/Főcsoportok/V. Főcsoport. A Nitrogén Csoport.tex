    ...
    \subsection{A vegyületei}
        ...
        \subsubsection{Oxosavai}
            ...
            \begin{itemize}
                ...
                \subsubsubsection{Reakciói}
                \begin{enumerate}
                    \item Reakció vízzel
                    \item Reakció klórral
                    \[
                    ...
                    \]
                    Az ammónium-klorid régies neve szalmióksó.
                \end{enumerate}
...
\subsection{Foszfor}
    ...
    \hline 
    Szerkezet & Pa-molekula & Hosszú tetraéderekből\\
    \hline
    Oldhatóság & Alacsony olvadáspont & Magas olvadáspont\\
    \hline 
    Élettani hatás & Mérgező* & Nem mérgező** \\
    \end{tabular}
    
    *Bőrön keresztül is felszívódik
    **Mivel fel sem tud olvadni

    Gyufa.\\
    Az emberek rájöttek, hogy szükség volt rá, hogy maguknak tudjanak tüzet gyújtani - a dohányzás miatt

    Ezért jött létre a gyufa
    
    Elterjedt öngyilkossági módszer volt, hogy lekaparták a fehérfoszfort a gyufa tetejéről, majd megitták. Ezért meg akarták változtatni az emberek a gyufát, hogy ne kelljen hozzá fehérfoszfor.

    Erre a vörösfoszfor volt a megoldás. A fehérfoszfor a gyújtás pillanatában keletkezik csak, és rögtön el is ég, így tehát nem veszélyes.

    % TODO: Improve gyufa section
    ...
    \begin{enumerate}
        ...
        \]
        \subsubsection{Foszfor-pentoxid}
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \begin{enumerate}
                    ...
                    \[
                    H_3PO_4 + H_2O \leftrightarrow \underset{\text{Dihidrogénfoszfát-ion}}{H_2PO_4^-} + H_3O^+
                    \]
                    \[
                    H_2PO_4^- + H_2O \leftrightarrow \underset{\text{Hidrogénfoszfát-ion}}{HPO_4^{2-}} + H_3O^+
                    \]
                    \[
                    HPO_4^{2-} + H_2O \leftrightarrow \underset{\text{Foszfát-ion}}{PO_4^{3-}} + H_3O^+
                    \]
                    % TODO: Show H^+ flow
                \end{enumerate}
                \item Fontosabb sói
                \begin{itemize}
                    ...
                    Itt X lehet
                    \begin{itemize}
                        \item $X = OH$ $\implies$ (fluor)apatit $\rightarrow$ Fogzománc (ezért fontos fluorid-alapú fogkrémet használni)
                        \item $X = F$.
                    \end{itemize}
                \end{itemize}
            \end{itemize}
