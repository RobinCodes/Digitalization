...
\date{Legutolsó frissítés: 2026. Március 16.}
...
\section{Számok összege, négyzetek összege, köbök összege...}
\[
1^2 = 1^2 \qquad\qquad\qquad\qquad\qquad =1^2
\]
\[
...
\]
\[
4^2 = (3+1)^2 = 3^2 + 2\cdot3\cdot1 + 1^2 = 3^2 + 2\cdot 3 + 1
\]
...
\[
n^2 = ((n-1) + 1)^2 = (n-1)^2 + 2\cdot(n-1)\cdot1 + 1^2 = (n-1)^2 + 2(n-1) + 1
\]
\[
...
\[
1^2 + 2^2 + ... + n^2 + (n+1)^2 = 1^2 + 2^2 + ... + n^2 + 2\cdot(1 + 2 + ... + n) + (n+1)
\]
\[
(n+1)^2 = 2\cdot(1 + 2 + ... + n) + (n + 1)
\]
\[
n^2 + 2n + 1 - n - 1 = 2(1 + 2 + ... + n)
\]
\[
\frac{n(n+1)}{2} = \frac{n^2 + n}{2} = 1 + 2 + ... + n
\]
...
\]
\[
1^3 = 1^3\qquad\qquad\qquad\qquad\qquad\qquad = 1
\]
\[
...
\]
\[
4^3 = (3 + 1)^3 = 3^3 + 3 \cdot 3^2 \cdot 1 + 3\cdot3\cdot1^2 + 1^3 = 3^3 + 3 \cdot 3^2 + 3 \cdot 3 + 1
\]
\[
5^3 = (4 + 1)^3 = 4^3 + 3 \cdot 4^2 \cdot 1 + 3 \cdot 4 \cdot 1^2+ 1^3 = 4^3 + 3 \cdot 4^2 + 3\cdot 4 + 1
\]
\[
(n + 1)^3 = \qquad\qquad\qquad\qquad\qquad\qquad\qquad = n^3 + 3\cdot n^2 + 3\cdot n + 1
\]

\hrule

\[
1^3 + 2^3 + ... + n^3 + (n + 1)^3 = 1^3 + 2^3 + ... + n^3 + 3 \cdot(1^2 + 2^2 + ... + n^2) + 3 \cdot (1 + 2 + ... + n) + (n + 1)
\]
\[
(n + 1)^3 = 3 \cdot (1^2 + 2^2 + ... +  n^2) + 3\cdot \frac{n(n + 1)}{2} + (n + 1) \qquad /\cdot2
\]
Legyen $1^2 + 2^2 + ... + n^2 = x$
\[
...
\]
\[
1^2 + 2^2 + 3^2 + ... + n^2 = \frac{n(n + 1)(2n + 2)}{6}
\]

% Todo: do for n^4.  extra studies: generalize
