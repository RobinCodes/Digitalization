...
Egybe írjuk a következő utótagú országneveket/nagy tájegységek nevét:
\begin{itemize}
...
\begin{itemize}
    ...
    \item öböl
    \item stb.
    \item pl. Velencei-tó, Sólyom-sziget, Szabadság-hegy, Dunántúli-középhegység, Csendes-ócéán stb.
\end{itemize}
...
\begin{itemize}
    ...
    \item Balaton-felvidék\textrightarrow Balato-felvidéki
...
\subsection{Ha az útótag tulajdonnév}
...
\begin{itemize}
    \item pl. Római Birodalom, Kijevi Nagyfejedelemség, Egyesült Királyság, Amerikai Egyesül Államok
\end{itemize}

\subsubsection{-i képzős alakok}
-i lépzős alakban minden tagot kisbetűvel írunk
\begin{itemize}
...
\begin{itemize}
    ...
    \begin{itemize}
        \item Duna-Tisza köze, Szeksszárd vidéke, Dráva mente, Pest környéke
    \end{itemize}
\end{itemize}

\subsubsection{-i képzős alakok}
-i képzős alakokban az előtagot nagybetűvel, az előtagot kisbetűvel írjuk
\begin{itemize}
