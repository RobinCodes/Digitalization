...
\begin{itemize}
    ...
    \item Helyetesíthetnek: \begin{itemize}
        \item Főnevet
        \item Melléknevet
        \item Számnevet
        \item Határozószót
...
\begin{itemize}
    ...
    \item Ragos alakok pl: \begin{itemize}
        ...
        \item rólam, rólad, róla, rólunk, rólatok, róla, Önről, Magáról, Kegyedről
        \item nálam, málad, nála, nálunk, nálatok, náluk, Önnél, Magánál, Kegyednél
    \end{itemize}
...
\subsection{Visszatató névmás}
\begin{itemize}
    \item maga + toldalék
    \item Kifejezheti: \begin{itemize}
        \item Egyedüllétet pl: A gyerekek egész nap maguk voltak.
        \item Egyedüli, segíség nélküli cselekvést pl: Péter maga készítette el az ebédet. 
    \end{itemize}
\end{itemize}
...
\hline
     Névmás & Fönévi & Melléknévi & Számnévi & Határozószói \\ \hline
