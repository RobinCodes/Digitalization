...
\date{Last updated: 17 March 2026}
...
\begin{proposition}
  $\nexists$ gold that he hasn't stolen
\end{proposition}
\begin{proof}
    We prove by disproving the opposite of the proposition that $\exists\text{ gold that he hasn't stolen}$
    \\ \\
    We number each of the gold coins one by one from 1 to infinity; now $\nexists$ gold for which we can't tell on which day it was stolen. $\implies$ $\nexists\text{ gold that he hasn't stolen}$
